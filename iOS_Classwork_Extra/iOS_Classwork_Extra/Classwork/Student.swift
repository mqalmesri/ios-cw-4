...
var students: [Studenet] =
    [
        Studenet(name: "ريم خالد", track: "ios", gender: "girl"),
        Studenet(name: "صالح شهاب", track: "web", gender: "boy"),
        Studenet(name: "محمد علي", track: "Andriod", gender: "boy")
    ]
